//
//  GlobalDataCacheForMemorySingleton.m
//  SimpleApp
//
...
@synthesize isFirstStartApp = _isFirstStartApp;
@synthesize isNeedShowBeginnerGuide = _isNeedShowBeginnerGuide;
@synthesize isNeedAutologin = _isNeedAutologin;
...
#pragma mark -
#pragma mark - 对属性进行线程安全保护
//
- (BOOL)isFirstStartApp {
  __block BOOL localFirstStartApp;
  dispatch_sync(_syncQueue, ^{
    localFirstStartApp = _isFirstStartApp;
  });
  return localFirstStartApp;
}
- (void)setFirstStartApp:(BOOL)isFirstStartApp {
  dispatch_barrier_async(_syncQueue, ^{
    _isFirstStartApp = isFirstStartApp;
  });
}
//
- (BOOL)isNeedShowBeginnerGuide {
  __block BOOL localNeedShowBeginnerGuide;
  dispatch_sync(_syncQueue, ^{
    localNeedShowBeginnerGuide = _isNeedShowBeginnerGuide;
  });
  return localNeedShowBeginnerGuide;
}
- (void)setNeedShowBeginnerGuide:(BOOL)isNeedShowBeginnerGuide {
  dispatch_barrier_async(_syncQueue, ^{
    _isNeedShowBeginnerGuide = isNeedShowBeginnerGuide;
  });
}
//
- (BOOL)isNeedAutologin {
  __block BOOL localNeedAutologin;
  dispatch_sync(_syncQueue, ^{
    localNeedAutologin = _isNeedAutologin;
  });
  return localNeedAutologin;
}
- (void)setNeedAutologin:(BOOL)isNeedAutologin {
  dispatch_barrier_async(_syncQueue, ^{
    _isNeedAutologin = isNeedAutologin;
  });
}
